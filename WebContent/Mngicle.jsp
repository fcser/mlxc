...
<body>
   ...
   request.setCharacterEncoding("utf-8"); 
	...
	ArrayList<Article> news=ArticleDAO.findallArticlebytime(sort,0);
	...
	<form method="post" action=" " id="listform">
		...
		<table class="table table-hover text-center">
			...
			<c:forEach items="${basal}" var="stu1">
				...
				<tr>
					<td style="text-align: left; padding-left: 20px;"><input
						type="checkbox" name="id[]" value="" /> ${stu1.id }</td>
					...
					<td>${stu1.title}</td>
					<td>${stu1.intro}</td>
					<td><font color="#00CC99">${stu1.author}</font></td>
					<td>${stu1.sort }</td>
					<td>${stu1.time }</td>
					<td><div class="button-group">
							<a class="button border-main"
								href="Editarticle.jsp?id=${stu1.id}"><span class="icon-edit"></span>
								编辑</a> <a class="button border-red"
								href="deletearticle.jsp?id=${stu1.id}"
			...
			<td colspan="7" style="text-align: left; padding-left: 20px;"><a
				...
				class="button border-blue icon-edit" onclick="sorts()"> 排序</a> 操作： <select
				name="ishome" style="padding: 5px 15px; border: 1px solid #ddd;"
			...
			<tr>
				<td colspan="8"><div class="pagelist">
						<a href="Mng_article.jsp?arg=-1">首页</a><a
							href="Mng_article.jsp?arg=-2">上一页</a><a
							href="Mng_article.jsp?arg=-3">下一页</a><a
							href="Mng_article.jsp?arg=-4">尾页</a>
					</div></td>
			</tr>
		</table>
		</div>
