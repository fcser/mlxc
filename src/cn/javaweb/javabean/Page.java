...
public class Page {
    ...
    public void gotopage(int page)
    {
		...
		case -1:
			...
			break;
		case -2:
			//int t=this.getCurrentp();
			//System.out.println("t="+t);
			//this.setCurrentp(t-1);
			CurrentPage.currentp=CurrentPage.currentp-1;
			break;
		case -3:
			//int n=this.getCurrentp();
			//System.out.println("n="+n);
			//this.setCurrentp(n+1);
			CurrentPage.currentp=CurrentPage.currentp+1;
			break;
		case -4:
			//this.setCurrentp(this.getAllp());
    ...
    public void setp(ResultSet rs,int page,int pagesize)//我也不知道是啥，哈哈哈
    {
    	setPagesize(pagesize);
    	 /*try {
 			setAllr(rs.getRow());
 			System.out.println("总查询数："+this.getAllr());
